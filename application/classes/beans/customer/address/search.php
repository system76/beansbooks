...
/*
---BEANSAPISPEC---
@action Beans_Customer_Address_Search
@description Search for customer addresses.
@required auth_uid
@required auth_key
...
@returns addresses ARRAY An array of #Beans_Customer_Address#.
...
---BEANSENDSPEC---
*/
class Beans_Customer_Address_Search extends Beans_Customer_Address {
	...
	protected function _execute()
	{
		if( $this->_search_customer_id )
			$this->_addresses = $this->_addresses->where('entity_id','=',$this->_search_customer_id);
		...
		return (object)array(
			...
			"addresses" => $this->_return_customer_addresses_array($result_object->addresses),
		);
	}
