...
/*
---BEANSAPISPEC---
@action Beans_Customer_Sale_Line_Search
...
@returns sale_lines ARRAY An array of objects representing a #Beans_Customer_Sale_Line# with the most recently used information.
@returns @attribute sale_lines description The description of the line item.
@returns @attribute sale_lines amount The most recent amount assigned to that line item.
@returns @attribute sale_lines quantity The most recent quantity assigned to that line item.
@returns @attribute sale_lines total The total based on the amount and quantity.
@returns @attribute sale_lines account_id The most recent account attributed to that line item.
---BEANSENDSPEC---
*/
class Beans_Customer_Sale_Line_Search extends Beans_Customer_Sale_Line {
