...
/*
---BEANSAPISPEC---
@action Beans_Vendor_Address_Shipping_Update
@description Create a new vendor shipping address.
@required auth_uid 
@required auth_key 
@required auth_expiration
@required id INTEGER The ID of the #Beans_Vendor_Address_Shipping# to be updated.
...
---BEANSENDSPEC---
*/
class Beans_Vendor_Address_Shipping_Update extends Beans_Vendor_Address {
