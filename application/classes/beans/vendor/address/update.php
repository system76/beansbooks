...
/*
---BEANSAPISPEC---
@action Beans_Vendor_Address_Update
@description Update a vendor address.
@required auth_uid 
@required auth_key 
@required auth_expiration
@required id INTEGER The ID of the #Beans_Vendor_Address# to update.
...
@returns address OBJECT The updated #Beans_Vendor_Address#.
---BEANSENDSPEC---
*/
class Beans_Vendor_Address_Update extends Beans_Vendor_Address {
	...
	protected function _execute()
	{
		...
		$this->_validate_vendor_address($this->_address);
