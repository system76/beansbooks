...
/*
---BEANSAPISPEC---
@action Beans_Vendor_Expense_Line_Search
...
@returns expense_lines ARRAY An array of objects representing a #Beans_Vendor_Expense_Line# with the most recently used information.
@returns @attribute expense_lines description The description of the line item.
@returns @attribute expense_lines amount The most recent amount assigned to that line item.
@returns @attribute expense_lines quantity The most recent quantity assigned to that line item.
@returns @attribute expense_lines total The total based on the amount and quantity.
@returns @attribute expense_lines account_id The most recent account attributed to that line item.
---BEANSENDSPEC---
*/
class Beans_Vendor_Expense_Line_Search extends Beans_Vendor_Expense_Line {
	...
	protected function _execute()
	{
		...
		$description_query .= ' WHERE forms.type = "expense" ';
		...
		foreach( $description_results as $description_result )
		{
			...
			$line_query .=	' AND forms.type = "expense" ';
