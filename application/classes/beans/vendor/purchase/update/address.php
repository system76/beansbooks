...
/*
---BEANSAPISPEC---
@action Beans_Vendor_Purchase_Update_Address
@description Update the address information on a purchase.  This is useful if you want to only update a single attribute without having to re-create or update the entire purchase.  
...
@optional shipping_address_id INTEGER The ID of the #Beans_Vendor_Address_Shipping# to assign for the shipping address.
@returns purchase OBJECT The updated #Beans_Vendor_Purchase#.
---BEANSENDSPEC---
*/
class Beans_Vendor_Purchase_Update_Address extends Beans_Vendor_Purchase {
