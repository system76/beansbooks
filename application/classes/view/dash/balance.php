...
class View_Dash_Balance extends View_Template {
	
	public function report_date()
	{
		if( ! isset($this->report_balance_result) )
			return FALSE;

		return $this->report_balance_result->data->date;
	}
	...
	public function account_types()
	{
		...
		foreach( $this->report_balance_result->data->account_types as $account_type )
