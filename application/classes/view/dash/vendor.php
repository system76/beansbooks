...
class View_Dash_Vendor extends View_Template {

	public function report_date_start()
	{
		if( ! isset($this->report_vendor_result) )
			return FALSE;

		return $this->report_vendor_result->data->date_start;
	}
	...
	public function report_date_end()
	{
		...
		return $this->report_vendor_result->data->date_end;
	}
	...
	public function report_vendor_id()
	{
		...
		return $this->report_vendor_result->data->vendor_id;
	}
	...
	public function report_vendor_name()
	{
		...
		return $this->report_vendor_result->data->vendor_name;
	}
	...
	public function report_title()
	{
		...
		return $this->report_vendor_result->data->title;
	}
	...
	public function report_line_range_label()
	{
		...
		return $this->report_vendor_result->data->report_line_range_label;
	}
	...
	public function report_lines()
	{
		...
		foreach( $this->report_vendor_result->data->report_lines as $report_line )
	...
	public function line_totals()
	{
		...
		return $this->_report_line_array($this->report_vendor_result->data->line_totals);
	}
